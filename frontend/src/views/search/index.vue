<template>
  <div>
    ...
    <main>
      ...
      <!--        &lt;!&ndash; <img src="Featured-Articles.png" alt="Featured Article Image">&ndash;&gt;-->
      <!--        <h2>Featured Article Title</h2>-->
      <!--        <p>Featured Article Description. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus.-->
      <!--            Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor.</p>-->
      <!--        <a href="#" style="visibility: hidden;" class="button">Read More</a>-->
      <!--    </section>-->
        ...
        <div style="overflow: auto">
          <a v-for="item in latestnews" class="news-article">
            <div style="display: flex">
              ...
              <div style="flex: 3"><img style="width: 230px;height: 200px" :src="item.imgUrl" :alt="item.headline.main">
              </div>
            </div>
...
export default {
  ...
  methods: {
    toSeach () {
      ...
      let obj = {
        q: this.keywords || "election",
        sort: "newest",
        page: 0,
        "api-key": "px6BIxzgpaYR16UhHTsCHrYOy2xhPMJD",
      }
      if (this.keywords == "election") {
        obj.begin_date = this.begin_date - 1
      }
